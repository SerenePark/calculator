(function (global) {
  ...
  var STRINGS = {
    ko: {
      ...
      adPreCheckoutTitle: "스폰서 광고",
      adImgAlt: "점핑캣 아케이드 모바일 게임 홍보 이미지",
      adCloseAria: "닫고 결제 진행",
      successTitle: "결제 완료",
    ...
    en: {
      ...
      adPreCheckoutTitle: "Sponsored ad",
      adImgAlt: "Jumping Cat Arcade mobile game promotion",
      adCloseAria: "Close and continue to payment",
